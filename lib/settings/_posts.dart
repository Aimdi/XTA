    ...
    return SettingsPageScaffold(
      ...
      body: SettingsList(
        children: [
          ...
          SettingsSection(
            title: L10n.of(context).language_filter,
            description: L10n.of(context).language_filter_description,
            children: [
              Padding(
              ...
              Padding(
                ...
                child: SegmentedButton<LanguageFilterAction>(
                  ...
                  onSelectionChanged: (value) =>
                      _saveLanguageAction(value.first),
                ),
              ),
              SettingsRow(
                title: L10n.of(context).language_filter_action,
                value: switch (_languageAction) {
                  LanguageFilterAction.hide =>
                    L10n.of(context).language_filter_hide,
                  LanguageFilterAction.fold =>
                    L10n.of(context).language_filter_fold,
                  LanguageFilterAction.off =>
                    L10n.of(context).language_filter_off,
                },
              ),
            ],
          ),
