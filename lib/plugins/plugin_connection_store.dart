...
class PluginConnectionState {
  ...
  const PluginConnectionState({
    this.status = PluginConnectionStatus.idle,
    this.message,
...
class PluginConnectionStore extends Store<PluginConnectionState> {
  ...
  int begin() {
    ...
    update(
      PluginConnectionState(
        status: PluginConnectionStatus.running,
        obscureKey: state.obscureKey,
        obscureSecret: state.obscureSecret,
      ),
    );
    return revision;
  }
  ...
  void toggleVisibility({bool secret = false}) => update(
    PluginConnectionState(
      status: state.status,
...
class PluginConnectionActions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Wrap(
      ...
      children: [
        FilledButton.icon(
          key: const ValueKey('plugin-test-connection'),
