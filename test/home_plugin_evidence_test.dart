...
class _Client extends RssClient {
  ...
  Future<List<RssItem>> fetchItems(RssFeed feed) async => const [
    RssItem(
      id: 'one',
      title: 'Designing a calmer place to read',
      feedId: 'design',
      feedTitle: 'The reading room',
      author: 'Alex Morgan',
      excerpt:
          'Good reading tools put the source and the story first. The interface should make the next page easy to find.',
    ),
    RssItem(
      id: 'two',
      title: 'Small details, better everyday journeys',
      feedId: 'design',
    ...
    RssItem(
      id: 'three',
      title: 'A library shaped around your interests',
      feedId: 'design',
      feedTitle: 'The reading room',
...
class _Communities extends RedditSubredditsStore {
  _Communities(super.prefs) {
    update(const ['flutter', 'technology', 'android']);
  }
  @override
