...
void main() {
  const post = BlueskyPost(
    ...
    images: ['https://cdn.test/image.jpg', 'https://cdn.test/video.jpg'],
    imageIsVideo: [false, true],
    repostedByDid: 'did:plc:b',
  );
